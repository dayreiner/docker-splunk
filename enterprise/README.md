...
* `6.5.1`- Splunk Enterprise base image [Dockerfile](https://github.com/dayreiner/docker-splunk/blob/master/enterprise/Dockerfile)
* `6.5.1-monitor`, `latest` - Splunk Enterprise with Docker Monitoring [Dockerfile](https://github.com/dayreiner/docker-itmonitoring/blob/master/enterprise/Dockerfile)
